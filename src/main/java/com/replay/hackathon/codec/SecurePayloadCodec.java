...
public class SecurePayloadCodec implements PayloadCodec {
    ...
    private final CodecKeyService codecKeyService;

    public SecurePayloadCodec() {
        this.codecKeyService = new CodecKeyService();
    }
    ...
    private Payload encodePayload(Payload payload) {
        ...
        final CodecKeyService.EncodingKey currentKey = codecKeyService.getCurrentKey();
    ...
    private Payload decodePayload(Payload payload) {
        ...
        if (METADATA_ENCODING.equals(
            ...
            SecretKey key = codecKeyService.getSecretKey(keyId);
